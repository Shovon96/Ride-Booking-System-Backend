    ...
    return (
        <footer className="bg-background border-t border-border">
            <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
                ...
                {/* Content Section */}
                <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32 content-right">
                    {/* Left Column */}
                    ...
                    {/* Right Column */}
                    <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-2 lg:text-left mx-auto lg:gap-24">
                        {/* About */}
                        <div>
                ...
                <div className="mt-16 border-t border-border pt-8">
                    <p className="text-center text-xs text-primary">
                        © CHOLORIDE 2025. All rights reserved.
                        <br /></p>
                </div>
            </div>
        </footer>
